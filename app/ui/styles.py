STYLE = """
QWidget { background: #f5f7f8; color: #17252b; font-size: 14px; }
QMainWindow { background: #f5f7f8; }
QPushButton { background: #126e70; color: white; border: 0; border-radius: 5px; padding: 9px 15px; font-weight: 600; }
QPushButton:hover { background: #0d585a; }
QLineEdit, QSpinBox, QDoubleSpinBox, QComboBox { background: white; border: 1px solid #c9d5d6; border-radius: 4px; padding: 7px; }
QTableWidget { background: white; border: 1px solid #d7e0e0; gridline-color: #e4ebeb; }
